...
if(fs.existsSync('src/renderer.js')){const source=fs.readFileSync('src/renderer.js','utf8').replace(/\r\n/g,'\n'),size=Buffer.byteLength(source,'utf8');const ceiling=290000;if(size>ceiling)findings.push(`src/renderer.js: architecture ceiling exceeded (${size} > ${ceiling} bytes)`);}
