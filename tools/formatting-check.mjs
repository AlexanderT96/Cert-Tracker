...
for(const asset of ['professional-overrides.css','professional-depth.css','professional-symbols.css','professional-typography.css','src/professional-icons.js']){
  require(index.includes(asset),`index.html is missing final presentation asset ${asset}`);
}
...
require(typography.includes('.cert-code'),'Certification code spacing rule is missing.');
...
console.log('Professional typography, spacing, tier-emblem and application-icon checks passed.');
