...
const requiredFiles = [
  ...
  'src/data-health.js','src/market-value.js','src/recommendation-engine.js','src/exports.js','src/notifications.js',
...
try {
  ...
  for (const file of ['src/path-defaults.js','src/config.js','src/storage.js','src/market-value.js','src/recommendation-engine.js','src/sync.js','src/market-value-ui.js','src/bootstrap.js']) if (!sw.includes(file)) errors.push(`Service worker does not cache ${file}`);
