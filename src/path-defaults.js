...
(function(global){
  ...
  const additions=Object.freeze(['linux-plus']);
  const previousIds=Object.freeze(ids.filter(id=>!additions.includes(id)));
  const previousPaths=Object.freeze([previousIds,Object.freeze(previousIds.filter(id=>!['az-700','az-802'].includes(id)))]);
  global.CERT_TRACKER_FOCUSED_ROUTE=Object.freeze({id:'network-platform-v3',title:'Network, cloud and automation engineering',ids,phases,additions,previousIds,previousPaths});
