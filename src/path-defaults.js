...
(function(global){
  ...
  const groups=[
    ...
    ['Windows Server, Azure and platform security',['az-802','az-104','az-700','sc-300','crowdstrike-ccfa','sc-500'],'Server administration, Azure networking, identity and endpoint controls'],
  ...
  const additions=Object.freeze(['az-700','az-802']);
  const previousIds=Object.freeze(ids.filter(id=>!additions.includes(id)));
  global.CERT_TRACKER_FOCUSED_ROUTE=Object.freeze({id:'network-platform-v2',title:'Network, cloud and automation engineering',ids,phases,additions,previousIds});
